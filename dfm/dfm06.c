...
float print_gpx() {
  ...
  a=gpx.h;
  //a=18000;
  b=acos( sin(lath*PI/180)*sin(gpx.lat*PI/180) + cos(lath*PI/180)*cos(gpx.lat*PI/180)*cos(gpx.lon*PI/180-lonh*PI/180) ) * 6371000;
  // 53.2775885,9.6309164
  //b=acos( sin(lath*PI/180)*sin(53.2775885*PI/180) + cos(lath*PI/180)*cos(53.2775885*PI/180)*cos(9.6309164*PI/180-lonh*PI/180) ) * 6371000;
